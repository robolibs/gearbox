...
use crate::host::CoverTerrainRoots;
...
impl MaterialExtension for AntiRepeatTerrainExtension {
    fn fragment_shader() -> ShaderRef {
        "embedded://gearbox_fields/harvested_wheat/shaders/material.wgsl".into()
    }
}
...
fn apply_anti_repeat_material_to_usd_terrain(
    ...
    terrain_roots: Res<CoverTerrainRoots>,
                ...
                .or_insert_with(|| {
                    materials.add(ExtendedMaterial {
                        ...
                        extension: AntiRepeatTerrainExtension {
                            ...
                            terrain_detail_height: asset_server.load("embedded://gearbox_fields/harvested_wheat/textures/detail_height.jpg"),
                            tint,
        ...
        app.world_mut()
            ...
            .register(FieldProfile {
                ...
                layers: vec![VegetationLayer {
                    shader: "embedded://gearbox_fields/harvested_wheat/shaders/vegetation.wgsl",
                    template: stalk_near,
                    density: stalks,
                    fade_start: 5.0,
                    fade_end: 32.0,
...
fn create_ground(
    ...
    let extension = AntiRepeatTerrainExtension {
        terrain_albedo: assets
            ...
            .load("embedded://gearbox_fields/harvested_wheat/textures/soil_albedo.jpg"),
        terrain_height: assets
            .load("embedded://gearbox_fields/harvested_wheat/textures/soil_height.jpg"),
        terrain_detail_albedo: assets
            .load("embedded://gearbox_fields/harvested_wheat/textures/detail_albedo.jpg"),
        terrain_detail_height: assets
            .load("embedded://gearbox_fields/harvested_wheat/textures/detail_height.jpg"),
        tint: Vec4::ONE,
        tracks,
        wheels,
...
// Every entity under a root, the root itself included.
