...
fn ploughed_ground(
    ...
    ground(
        ...
        geometry,
        BareGround {
            tint: Vec4::new(0.115, 0.082, 0.052, 1.0),
            grain: Vec4::new(0.42, 1.0, 0.9, 0.62),
        },
        0.93,
    )
}
...
fn dirt_ground(
    ...
    ground(
        ...
        geometry,
        BareGround {
            tint: Vec4::new(0.20, 0.165, 0.125, 1.0),
            grain: Vec4::new(0.3, 0.45, 0.1, 0.5),
        },
        0.88,
    )
}
...
fn sand_ground(
    ...
    ground(
        ...
        BareGround {
            ...
            tint: Vec4::new(0.30, 0.245, 0.16, 1.0),
